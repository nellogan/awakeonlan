...
void AWakeOnLAN::SetIPAddr(char* ip_addr_arg, bool ipv6_toggle_val)
{
    ...
    {
        ip_addr = ipv6_toggle_val == false ? DEFAULT_IPV4_BCAST : DEFAULT_IPV6_MCAST;
    }
    else
    {
...
void AWakeOnLAN::SetMac(char *mac_arg)
{
    ...
    {
        throw std::invalid_argument("Error: AWakeOnLAN::SetMac, MAC Address must be 6 bytes long and formatted such that "
